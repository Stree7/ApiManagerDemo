...
extern NSString *const ServiceOrderCancelReasonIdentifier ;
extern NSString *const ServiceCategoryFirstLevelIdentifier ;

@interface LGDemoService : NSObject <LGServiceProtocol>
